...
export default function TwelveCashLogo(props:TwelveCashLogoProps) {
    return(
        <>
            <Link href="/" className={`${props.size === 'large' ? 'text-4xl' : 'text-2xl'} bg-purple-800 bg-gradient-to-br from-[#00F0FF]/40 to-[#00F0FF]/0 inline-block rounded-full text-white tracking-tight font-light no-underline overflow-hidden shadow-lg flex-none`}>
